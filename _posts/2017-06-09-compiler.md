...
Some errors can come from [casts like `(int) Comparable<T>`][tar]:

[tar]: https://github.com/CodeFX-org/java-9-wtf/tree/master/./compiler/src/main/java/wtf/java9/compiler/CastWildcardParam.java
